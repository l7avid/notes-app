...
export default function AuthForm({onSignUp, onLogin, loading}: AuthFormProps) {
      ...
      <KeyboardAvoidingView
        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <View style={styles.inner}>
            ...
            <View style={styles.input}>
              <Button
                btnText={mode === 'login' ? 'Iniciar sesión' : 'Registrarse'}
            ...
            <View style={styles.footer}>
              ...
              <Button
                btnText={mode === 'login' ? 'Regístrate' : 'Inicia sesión'}
